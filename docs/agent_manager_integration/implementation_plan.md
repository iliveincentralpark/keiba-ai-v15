...
#### [NEW] [manager.py](file:///Users/kojimarei/Desktop/Antigravity/keiba_project/backend/agents/manager.py)
複数のエージェント（Scoring, Strategyなど）を統括し、最終的な予測結果をまとめる「Agent Manager」クラス。

#### [NEW] [scoring_agent.py](file:///Users/kojimarei/Desktop/Antigravity/keiba_project/backend/agents/scoring_agent.py)
全頭のスコアリング（期待値、実力指数、安定度）を担当するエージェント。

#### [NEW] [strategy_agent.py](file:///Users/kojimarei/Desktop/Antigravity/keiba_project/backend/agents/strategy_agent.py)
スコアリング結果に基づき、具体的な買い目戦略（3連複本命流し、馬連妙味軸など）を立案するエージェント。

### [Component Name] Backend API

#### [MODIFY] [main.py](file:///Users/kojimarei/Desktop/Antigravity/keiba_project/backend/main.py)
- `/api/predict` エンドポイントを新設し、`AgentManager` を呼び出すように変更。

### [Component Name] Frontend

#### [NEW] [app_v15.js](file:///Users/kojimarei/Desktop/Antigravity/keiba_project/app/js/app_v15.js)
